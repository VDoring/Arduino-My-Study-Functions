...
int sensor_CdS_3; //조도센서 3
int sensor_CdS_4; //조도센서 4
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
            ...
            sensor_CdS_2 = analogRead(A1); //조도센서 2 값 읽기
            sensor_CdS_3 = analogRead(A2); //조도센서 3 값 읽기
            sensor_CdS_4 = analogRead(A3); //조도센서 4 값 읽기
          ...
          client.print("<h2>CdS 3(A2): "); //조도센서 3 값 출력
          client.print(sensor_CdS_3);
          client.print("</h2>\r\n");

          client.print("<h2>CdS 4(A3): "); //조도센서 4 값 출력
          client.print(sensor_CdS_4);
          client.print("</h2>\r\n");
